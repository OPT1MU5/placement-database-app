...
import 'edu_details1_model.dart';
export 'edu_details1_model.dart';

class EduDetails1Widget extends StatefulWidget {
  const EduDetails1Widget({Key? key}) : super(key: key);

  @override
  _EduDetails1WidgetState createState() => _EduDetails1WidgetState();
}

class _EduDetails1WidgetState extends State<EduDetails1Widget> {
  late EduDetails1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EduDetails1Model());

    _model.schoolNameController ??= TextEditingController();
    _model.regNumController ??= TextEditingController();
    _model.marksScoredController ??= TextEditingController();
    _model.name12Controller ??= TextEditingController();
    _model.regNum12Controller ??= TextEditingController();
    _model.marksScored12Controller ??= TextEditingController();
            ...
            children: [
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  maxLines: null,
                  validator:
                      _model.regNum12ControllerValidator.asValidator(context),
                ),
              ),
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 16.0),
